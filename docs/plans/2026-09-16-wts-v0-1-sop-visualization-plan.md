...
- `visualization/wts-v0-1-sop/dist/index.html`, `styles.css`, and `app.js`.
...
Run: `python -m unittest discover -s tests -p 'test_wts_sop_visualization.py' -v`
...
**Files:**
- Create: `visualization/wts-v0-1-sop/dist/index.html`
...
**Files:**
- Create: `visualization/wts-v0-1-sop/dist/styles.css`
...
**Files:**
- Create: `visualization/wts-v0-1-sop/dist/app.js`
...
**Files:**
- Create: `visualization/wts-v0-1-sop/.openai/hosting.json`
- Verify: `visualization/wts-v0-1-sop/dist/index.html`
- Verify: `visualization/wts-v0-1-sop/dist/styles.css`
- Verify: `visualization/wts-v0-1-sop/dist/app.js`
...
Run: `python -m http.server 8765 --directory visualization/wts-v0-1-sop/dist`
