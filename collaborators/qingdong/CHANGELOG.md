...
- **校准门（新步骤 11.3，step_id=calibrate）**：第 1 轮评完分后给用户看 2 位推荐、1 位不推荐的匿名摘要和一句依据，问"这个尺度对吗"；偏松/偏严时改需求版本并重评已评分候选人，再继续扩张或第 2 轮。第 2 轮起不再做。
...
- 长任务跑三轮才发现尺度偏了代价太大，第 1 轮后花一次提问校准最划算。
